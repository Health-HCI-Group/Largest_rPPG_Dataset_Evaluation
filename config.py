...
_C.TRAIN.DATA.INFO.FITZPATRICK = ['']
_C.TRAIN.DATA.INFO.LOCATION = ['']
_C.TRAIN.DATA.INFO.FACIAL_MOVEMENT = ['']
_C.TRAIN.DATA.INFO.TALKING = ['']
...
_C.TRAIN.DATA.PREPROCESS.CROP_FACE.BACKEND = ''
...
_C.VALID.DATA.INFO.FITZPATRICK = ['']
_C.VALID.DATA.INFO.LOCATION = ['']
_C.VALID.DATA.INFO.FACIAL_MOVEMENT = ['']
_C.VALID.DATA.INFO.TALKING = ['']
...
_C.VALID.DATA.PREPROCESS.CROP_FACE.BACKEND = ''
...
_C.TEST.DATA.INFO.FITZPATRICK = ['']
_C.TEST.DATA.INFO.LOCATION = ['']
_C.TEST.DATA.INFO.FACIAL_MOVEMENT = ['']
_C.TEST.DATA.INFO.TALKING = ['']
...
_C.TEST.DATA.PREPROCESS.CROP_FACE.BACKEND = ''
...
_C.UNSUPERVISED.DATA.INFO.FITZPATRICK = ['']
_C.UNSUPERVISED.DATA.INFO.LOCATION = ['']
_C.UNSUPERVISED.DATA.INFO.FACIAL_MOVEMENT = ['']
_C.UNSUPERVISED.DATA.INFO.TALKING = ['']
...
_C.INFERENCE.SNN_PATH = ''
_C.INFERENCE.ANN_PATH = ''
