...
class vvAllLoader(BaseLoader):
    ...
    def read_wave(dir, filename):
        with h5py.File(os.path.join(dir,"vvAllCompressed_ts_bvps.h5"), 'r') as hf:
    ...
    def read_ts(dir, filename):
        with h5py.File(os.path.join(dir,"vvAllCompressed_ts_frames.h5"), 'r') as hf:
            dataset_name = filename
            array = hf[dataset_name][:]
            return array[0], array[1]
    ...
    def get_information(information):
        ...
        if information[0] == 'M':
            ...
            raise ValueError("Error with vvAllCompressed dataset labels! "
        ...
        if information[2] == 'KLL':
            ...
            location = 3
        elif information[2] == 'T' or information[2] == 'T ':
            location = 4
